...
export default {
  ...
  methods: {
    ...
    formUser1(e) {
      ...
      const name = e.target.elements.uid.value;
      const age = e.target.elements.uid.value;
  ...
  data() {
    return {
      ...
      persons: [
        ...
        { uid: "a102", name: "강감찬", age: 21 },
        { uid: "a103", name: "이름", age: 33 },
        { uid: "a104", name: "몰라", age: 43 },
        { uid: "a105", name: "잘래", age: 53 },
      ],
      value1: "tit1",
      value2: "tit2",
      count: 0,
...
<template>
  ...
  <form v-on:submit.pervent="formUser1" method="post">
  ...
  <form @:submit.pervent="formUser2" method="post">
