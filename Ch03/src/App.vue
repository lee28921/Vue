...
import PropsComponent4 from "./components/PropsComponent4.vue";

export default {
  name: "App",
  data() {
    return {
      clities: ["서울", "대전", "대구", "부산", "광주"],
      isShow: true,
    };
  },
  methods: {
    emitHander: function (data) {
...
<template>
  ...
  <ul>
    <PropsComponent2 v-for="city in clities" :myCity="city" />
  </ul>

  <PropsComponent3 c3Name="홍길동" c3Age="23" />
  <EmitComponent1 name="홍길동" age="12" v-on:myEmit="emitHander" />
